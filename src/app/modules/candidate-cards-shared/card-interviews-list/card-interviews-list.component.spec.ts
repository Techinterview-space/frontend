...
import { CardInterviewsListComponent } from './card-interviews-list.component';

describe('CardInterviewsListComponent', () => {
  let component: CardInterviewsListComponent;
  let fixture: ComponentFixture<CardInterviewsListComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CardInterviewsListComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CardInterviewsListComponent);
