...
const routes: Routes = [
  ...
  {
    path: "templates/my",
    component: MyInterviewTemplatesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "templates/create",
    component: InterviewTemplateEditPageComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "create",
    component: InterviewEditPageComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "create/for-candidate-card/:cardId",
    component: InterviewEditPageComponent,
    canActivate: [AuthGuard],
  },
