...
import { CreateUserSalaryRequest, EditUserSalaryRequest } from "@services/user-salaries.service";
...
export class EditSalaryForm extends FormGroup {
  ...
  constructor(
    ...
    super({
      ...
      quarter: new FormControl(salarytoBeEditedOrNull?.quarter ?? currentQuarter, [
        Validators.pattern(EditSalaryForm.digitsPattern),
        Validators.min(1),
        Validators.max(4),
        Validators.required,
      ...
      currency: new FormControl(salarytoBeEditedOrNull?.currency ?? Currency.KZT, [
        Validators.required,
      ]),
      ...
      profession: new FormControl(salarytoBeEditedOrNull?.professionId ?? null, [
        Validators.required,
      ]),
