...
export class SalariesSurveyForm extends FormGroup {
  readonly usefullnessReplyOptions: Array<
    CheckboxRadioOption<UsefulnessReplyType>
  > = [
    {
      label: "Да",
  ...
  readonly expectationReplyOptions: Array<
    CheckboxRadioOption<ExpectationReplyType>
  > = [
    {
