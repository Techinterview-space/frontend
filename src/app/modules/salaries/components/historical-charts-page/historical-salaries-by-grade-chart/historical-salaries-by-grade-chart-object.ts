import { SalariesCountWeekByWeekChart, SalariesCountWeekByWeekChartGradeItem } from "@services/historical-charts.service";
    ...
    constructor(canvasId: string, chartData: SalariesCountWeekByWeekChart) {
      ...
      datasets.push(
        ...HistoricalSalariesByGradeChartObject.getDatasetForGrade(
          DeveloperGrade.Junior, juniorSalaries, true,
        ),
        ...HistoricalSalariesByGradeChartObject.getDatasetForGrade(
          DeveloperGrade.Middle, middleSalaries, true,
        ),
        ...HistoricalSalariesByGradeChartObject.getDatasetForGrade(
          DeveloperGrade.Senior, seniorSalaries, true,
        ),
        ...HistoricalSalariesByGradeChartObject.getDatasetForGrade(
          DeveloperGrade.Lead, leadSalaries, true,
        ),
      );
