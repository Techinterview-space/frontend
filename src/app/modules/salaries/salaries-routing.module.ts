...
const routes: Routes = [
  {
    ...
    data: {
      ...
      description: 'Здесь можно увидеть статистику по зарплатам в IT в Казахстане. Есть множество графиков по разным критериям, а также возможность применить необходимые фильтры.',
      url: '/salaries'
    }
  },
];
