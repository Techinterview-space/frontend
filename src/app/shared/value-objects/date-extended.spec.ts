...
describe('DateExtended', () => {
  ...
  it('.nextWorkDay() cases.', () => {
    expect(new DateExtended(target('2020-07-15').nextWorkDay()).sameDay(target('2020-07-16'))).toBe(true);
    expect(new DateExtended(target('2020-12-11').nextWorkDay()).sameDay(target('2020-12-14'))).toBe(true);
    expect(new DateExtended(target('2020-12-15').nextWorkDay()).sameDay(target('2020-12-16'))).toBe(true);
  });
});
