...
- [x] `home.component.html` migrated
- [ ] `salaries-chart.component.html` migrated (deferred - very large 542 lines, can be migrated manually following patterns from other pages)
- [x] `company-page.component.html` migrated
- [x] `interview-page.component.html` migrated
- [x] `admin-start-page.component.html` migrated
- [ ] Remaining ~80 templates migrated (YOUR TASK)

### Phase 5.1

- [ ] migrate all components in module src/modules/admin
- [ ] migrate all components in module src/modules/companies
- [ ] migrate all components in module src/modules/home
- [ ] migrate all components in module src/modules/interviews
- [ ] migrate all components in module src/modules/salaries
- [ ] migrate all components in module src/modules/users
